...
When developping you can start the web server with the [Nushell](https://www.nushell.sh/): `nu run.nu` . The modules are automatically reloaded when modified, it uses [radiate](https://radiate.hexdocs.pm/) in dev mode.
