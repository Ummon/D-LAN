...
translate(es, features, disclaimer) -> "";
...
translate(es, about, tech_used_d_lan) ->
   "<li></li>"
   "<li></li>"
   "<li></li>"
   "<li></li>"
...
translate(es, about, tech_used_tools_title) -> "";
...
translate(es, about, tech_used_tools) ->
   "<li></li>"
   "<li></li>"
   "<li></li>"
   "<li></li>"
...
translate(es, about, tech_used_website_title) -> "";
...
translate(es, about, tech_used_website) ->
   "<li>/li>"
   "<li>/li>"
   "<li>/li>"
   "<li>/li>"
...
translate(es, download_button, torrent) -> "";

translate(fr, _, _) -> "<<traduction manquante>>";
translate(es, _, _) -> "";
