...
namespace RCC
{
   ...
   {
      Q_OBJECT
      static const int DEFAULT_SOCKET_TIMEOUT = 5000; // 5 seconds.
   ...
   public:
      ...
      QSharedPointer<ILocalBrowseResult> localBrowse(const QString& path, bool onlyDirectories = false) override;
