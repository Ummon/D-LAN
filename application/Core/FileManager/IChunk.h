...
namespace FM
{
   ...
   public:
      ...
      /**
        ...
        * Set includeHashes to false for metadata only, without chunk records.
        * @return false if the entry hasn't been populated.
        */
      virtual bool populateEntry(Protos::Common::Entry* entry, bool includeHashes = true) const = 0;
