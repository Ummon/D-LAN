...
Protos::Queue::Queue DownloadQueue::loadFromFile()
{
   ...
   try
   {
      Common::PersistentData::getValue(Common::FILE_QUEUE, savedQueue, Common::Global::DataFolderType::LOCAL);
      if (static_cast<int>(savedQueue.version()) != FILE_QUEUE_VERSION)
      {
         ...
         Common::PersistentData::rmValue(Common::FILE_QUEUE, Common::Global::DataFolderType::LOCAL);
         savedQueue.Clear();
      }
   }
...
void DownloadQueue::saveToFile() const
{
   ...
   try
   {
      Common::PersistentData::setValue(Common::FILE_QUEUE, savedQueue, Common::Global::DataFolderType::LOCAL);
   }
