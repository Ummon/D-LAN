#ifndef DOWNLOADMANAGER_LOG_H
#define DOWNLOADMANAGER_LOG_H
...
namespace DM
{
   // There is only one logger for the DownloadManager component.
   static QSharedPointer<LM::ILogger> logger(LM::Builder::newLogger("DownloadManager"));
