...
proto_hash_cache.target = $$PWD/hash_cache.pb.cc
...
QMAKE_EXTRA_TARGETS += proto_queue proto_gui_settings proto_gui_protocol proto_hash_cache proto_files_cache proto_core_settings proto_core_protocol proto_common
PRE_TARGETDEPS += $$PWD/queue.pb.cc $$PWD/gui_settings.pb.cc $$PWD/gui_protocol.pb.cc $$PWD/hash_cache.pb.cc $$PWD/files_cache.pb.cc $$PWD/core_settings.pb.cc $$PWD/core_protocol.pb.cc $$PWD/common.pb.cc

OTHER_FILES += \
   $$PWD/queue.proto \
   $$PWD/gui_settings.proto \
   $$PWD/gui_protocol.proto \
   $$PWD/hash_cache.proto \
